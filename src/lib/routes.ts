...
export const TOOLS: ToolRoute[] = [
  ...
  },
  {
    ...
    title: "Генератор коробок STL — параметрические органайзеры для 3D-печати",
    description:
      "Параметрический STL коробки с размерами, ячейками, скруглением, " +
      "крышкой. Скачиваешь готовый файл для 3D-печати без установленного " +
      "CAD-редактора.",
    cardTitle: "Генератор коробок",
    cardDescription:
      "Параметрический STL: размеры, ячейки, крышка, скругление — готовый " +
      "файл для печати.",
    tag: "В разработке",
    category: "Генераторы",
    tint: "teal",
